# KP-BPSDMJABAR
Repositori ini berisi source code proyek Kerja Praktik (KP) terkait **Website BPSDM Jabar**.
Dalam proyek ini, kontribusi yang dilakukan berfokus pada penambahan dan pengembangan beberapa fitur dari sisi desain UI/UX pada website tersebut, sebagai bagian dari program magang/KP di Badan Pengembangan Sumber Daya Manusia (BPSDM) Provinsi Jawa Barat.
